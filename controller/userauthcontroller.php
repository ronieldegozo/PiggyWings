...
if(isset($_POST['signup-btn'])){
    ...
    if(count($errors) === 0) {
        ...
        $sql = "INSERT INTO users (fname,lname,address,username,email,verified,token,password) VALUES (?,?,?,?,?,?,?,?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param('sssssbss', $fname, $lname, $address,$username,$email, $verified, $token, $password);
